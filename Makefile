...
INCLUDES     =   -I include -I gpio/Inc -I sd-spi/Inc -I fat32/Inc -I buttons/Inc -I float/Inc -I st7735/Inc -I stm32lib -I usb/Inc -I usb/class -I kernel/Inc -I spi/Inc -I w25q/Inc
...
SRCST77         = $(wildcard st7735/Src/*.c)
ST77OBJ         = $(addprefix $(OBJDIR)/, $(addsuffix .o, $(notdir $(basename $(SRCST77)))))

SRCBUTTONS         = $(wildcard buttons/Src/*.c)
BUTTONSOBJ         = $(addprefix $(OBJDIR)/, $(addsuffix .o, $(notdir $(basename $(SRCBUTTONS)))))
...
SRCPATH      = $(sort $(dir $(SOURCES) $(SRCLIB) $(SRCGPIO) $(SRCUSB) $(SRCKERNEL) $(SRCFLOAT) $(SRCBUTTONS) $(SRCST77) $(SRCSPI) $(SRCFAT32) $(SRCSDSPI) $(SRCW25Q) ))
vpath %.c $(SRCPATH)
vpath %.S $(SRCPATH)
...
$(DOUT).elf : $(OBJDIR) $(LIBOBJ) $(GPIOOBJ) $(USBOBJ) $(kERNELOBJ) $(SPIOBJ) $(FLOATOBJ) $(ST77OBJ) $(SDSPIOBJ) $(FAT32OBJ) $(BUTTONSOBJ) $(W25QOBJ) $(OBJECTS) 
	@echo building $@
	@$(LD) $(CFLAGS2) $(LDFLAGS) -Wl,--script='$(LDSCRIPT)' $(LIBOBJ) $(GPIOOBJ) $(FLOATOBJ) $(ST77OBJ) $(USBOBJ) $(FAT32OBJ) $(SDSPIOBJ) $(BUTTONSOBJ) $(W25QOBJ) $(SPIOBJ) $(kERNELOBJ) $(OBJECTS) -o $@
